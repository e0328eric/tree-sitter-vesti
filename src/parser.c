...
enum ts_symbol_identifiers {
  ...
  sym_comment = 45,
  sym_vesti_content = 46,
  sym__statement = 47,
  sym_docclass_decl = 48,
  sym_singlepkg_decl = 49,
  sym_multipkg_decl = 50,
  sym_options = 51,
  sym_importmod_decl = 52,
  sym_copyfile_decl = 53,
  sym_importves_decl = 54,
  sym_getfp_decl = 55,
  sym_useenv_decl = 56,
  sym_begenv_decl = 57,
  sym_endenv_decl = 58,
  ...
  sym_optional_arg = 61,
  sym_luacode = 62,
  sym__text_content = 63,
  sym_brace_group = 64,
  sym_paren_group = 65,
  sym_sqparen_group = 66,
  sym__math = 67,
  sym_inline_math = 68,
  sym_display_math = 69,
  sym_text = 70,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 15:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(15);
      if (set_contains(sym_filepath_character_set_1, 430, lookahead)) ADVANCE(277);
      END_STATE();
    case 16:
      if (lookahead == '%') ADVANCE(2);
      if (('\t' <= lookahead && lookahead <= '\r') ||
